...
class fetchingdata
{
    ...
    public function insert_product($product)
    {
        ...
        // Assign value to $categorieID
        $categorieID = $product->getCategorieID();

        // ... (Previous code)

        $stmt->bindParam(':categorieID', $categorieID); // Ensure correct parameter name

        echo "Debugging: CategorieID = $categorieID"; 
...
// ...
        ...
        try {
          ...
          $error_input = "Error executing the query.";
          $color = "danger";
      }
            ...
            <table class="table table-striped table-hover " >
                ...
                <tbody class="table-group-divider">
                  ...
                  if (isset($_SESSION["admin"])) {
                      ...
                      // Check if $produitData is not null before using it in foreach
                      if (!is_null($produitData)) {
                          foreach ($produitData as $produit) {
                              // ... (Your existing code inside the foreach loop)
                          }
                      } else {
                          // Handle the case where $produitData is null
                          echo "No products found."; // You can customize this message
                      }
